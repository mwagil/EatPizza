...
namespace EatPizzaServices.Services
{
    public class OrderServices : IOrderServices
    {
        ...
        public OrderServices(ICustomerServices customerServices, IPizzaServices pizzaServices, EatPizzaContext context, IMapper mapper)
        {
